  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        circularDark: 'repeating-radial-gradient(rgba(245,245,245,0.5) 2px, #1b1b1b 8px, #1b1b1b 100px);',
        circularLightLg: 'repeating-radial-gradient(rgba(27,27,27,0.4) 2px, #f5f5f5 5px, #f5f5f5 80px);',
        circularDarkLg: 'repeating-radial-gradient(rgba(245,245,245,0.5) 2px, #1b1b1b 8px, #1b1b1b 80px);',
